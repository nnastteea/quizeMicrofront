...
- (Опционально) Реализовать простейшее Node.js / Express приложение и использовать сокетное подключение для того, чтобы создать комнаты, чтобы пользователи могли проходить тест и видеть общие результаты других пользователей по количеству правильных ответов;
